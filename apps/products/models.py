...
class CountCategory(models.Model):
    title = models.CharField(max_length=50)
    is_active = models.BooleanField(default=True)
...
class Product(models.Model):
    ...
    length = models.ForeignKey(Length, on_delete=models.CASCADE,verbose_name="uzunligi") #uzunligi
    width = models.ForeignKey(Width, on_delete=models.CASCADE,verbose_name="eni") #eni
    countCategory = models.ForeignKey(CountCategory, on_delete=models.CASCADE,verbose_name="Nechtaligi") #nechtaligi
